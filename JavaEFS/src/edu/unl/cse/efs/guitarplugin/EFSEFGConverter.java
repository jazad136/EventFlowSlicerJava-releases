...
import edu.umd.cs.guitar.model.wrapper.EFSJFCEventWrapper;
...
/**
 * Gui Structure to Event Flow Graph converter for purposes of CogToolHelper replay. 
 * 
 * The only real change to this class from the original EFG Converter is a change to the EventWrapper methods.
 * (encapsulated in CTHEventWrapper). This class uses CTHEventWrappers instead of EventWrapper.
 * 
 * Other than a removal of auxilary methods that were not necessary in this EFGGenerator related to graphviz, 
