...
//		touchable.addPropertyChangeListener(jta);
	}
		...
		public void mousePressed(MouseEvent me)
		{
			if(captureOn) {
				if(combo) {
					...
					if(me.getSource() instanceof TextComponent) {
//						testCase.saveComboText
					}
	 ...
	 *
	 */
	public class JavaTextListener implements KeyListener, FocusListener
	{
//		private final boolean combo;
...
//			this.combo = combo;
		...
		public void captureKey(Component c, KeyEvent oldKe)
		{
			KeyEvent newKE = new KeyEvent(c, oldKe.getID(),oldKe.getWhen(), 0, oldKe.getExtendedKeyCode(), oldKe.getKeyChar());
			keyPressed(newKE);
		}
