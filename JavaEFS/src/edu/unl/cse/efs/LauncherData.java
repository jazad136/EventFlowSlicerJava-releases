...
public class LauncherData {
	 ...
	 * @return
	 */
	public boolean sendsToRMI() { return !sendtoRMIPort.isEmpty(); }
	/**
	 * Returns the RMI port this object specifies
	 * @return
	 */
	public String getSendtoRMIPort() { return sendtoRMIPort; }

	public boolean hasLaunchSelectionArguments() { return !launchSelectionArguments.isEmpty(); }
	...
	public boolean sendsBackRMI() { return !sendbackRMIPort.isEmpty(); }
	public String getSendbackRMIPort() { return sendbackRMIPort; }
	...
	public void setGeneratorRunningType(GenType runningType) { this.generatorRunningType = runningType; }
	public GenType getGeneratorRunningType() { return generatorRunningType; }
	...
	public Map<PersonaFacet, PersonaType> getChosenPersonaArguments() { return providedPersonas; }
	public void setPersonaFacetType(PersonaFacet facet, PersonaType type) { providedPersonas.put(facet, type); }
