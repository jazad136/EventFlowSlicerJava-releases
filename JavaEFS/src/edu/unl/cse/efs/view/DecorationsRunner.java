...
//		GridBagConstraints myC = ((GridBagLayout)targetContainer.getLayout()).getConstraints(oldPanel);
...
//	public static GridBagConstraints constraints(int col, int row)
//	{
//		return ((GridBagLayout)targetContainer.getLayout()).getConstraints(smallPanels[col][row]);
//	}
